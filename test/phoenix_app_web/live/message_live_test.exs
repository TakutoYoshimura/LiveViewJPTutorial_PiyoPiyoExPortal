defmodule PhoenixAppWeb.MessageLiveTest do
  use PhoenixAppWeb.ConnCase

  import Phoenix.LiveViewTest
  import PhoenixApp.MessagesFixtures

  @create_attrs %{deleted_at: %{day: 24, hour: 7, minute: 55, month: 10, year: 2022}, display_name: "some display_name", message: "some message"}
  @update_attrs %{deleted_at: %{day: 25, hour: 7, minute: 55, month: 10, year: 2022}, display_name: "some updated display_name", message: "some updated message"}
  @invalid_attrs %{deleted_at: %{day: 30, hour: 7, minute: 55, month: 2, year: 2022}, display_name: nil, message: nil}
